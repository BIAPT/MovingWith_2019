...
% This function computes the feedforward, feedback, and asymmetry
% information transfer from the maximum entropy computed in f_FPM_MaxNSTE
% function.
%
% Input: filename 

load([fname '_maxNSTE.mat']);
