function [ssi_final, corrs, Z_1, Z_2] = rolling_SSI_sweep(subj1, subj2, fs,corr_win_size, corr_win_step, ssi_win_size, ssi_win_step,slope_win_size)
...
win_overlap = slope_win_size - win_step; % Overlap 

S_1 = buffer(Z_1,slope_win_size,win_overlap,'nodelay');
S_2 = buffer(Z_2,slope_win_size,win_overlap,'nodelay');
